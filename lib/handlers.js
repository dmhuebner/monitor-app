...
handlers.index = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    const templateData = {
      ...
      'head.description': 'Free, simple HTTP/HTTPS API uptime monitor tool. When sites/APIs you\'re monitoring go down, we\'ll send you a text to let you know. When they go back up we\'ll text you again to let you know.',
      'body.class': 'index'
    };
